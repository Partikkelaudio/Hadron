...
<~> @maxclass slider @varname adf @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname kitteadfans @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname fffew @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname poi @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname dfa @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname kittens @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname adf @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname kittens @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname dfa @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname adf @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname f @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname da @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname ad @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname kittenzs @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname adfafa @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname adfas @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname fffwq @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname vv3 @floatoutput 1 @min -1. @size 3. </~>
<~> @maxclass slider @varname v3tt3 @floatoutput 1 @min -1. @size 3. </~>
<CsoundSynthesizer>
<CsInstruments>
sr      = 44100
ksmps  	= 16
...
opcode reeverb, aa, aa
	...
	if kOn > 0 then	
        kin	     chnget "verb_feed"  ; <~> @maxclass slider @varname kittens @floatoutput 1 @min 0. @size 1. </~>
        krevtime chnget "verb_time"  ; <~> @maxclass slider @varname kittens @floatoutput 1 @min .05 @size 2999.95 </~>
        khiatt   chnget "verb_hiatt" ; <~> @maxclass slider @varname dook @floatoutput 1 @min 0. @size .99 </~>
        kpan     chnget "verb_pan"   ; <~>@maxclass slider @varname dook @floatoutput 1 @min 0. @size 360.</~>
        kdist    chnget "verb_dist"  ; <~> @maxclass slider @varname dook @floatoutput 1 @min 0.01 @size 14.99 </~>
        ktab     chnget "verb_tab"   ; <~> @maxclass slider @varname dook @floatoutput 1 @min 0. @size 1. </~>
