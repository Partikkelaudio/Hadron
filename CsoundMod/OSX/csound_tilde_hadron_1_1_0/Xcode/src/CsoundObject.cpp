	...
	try
	{
		m_midiBuffer.Clear();
			...
			if(sizeof(MYFLT) == sizeof(float))
				default_opcodedir = "/Applications/Hadron/Contents/Frameworks/CsoundLib.framework/Resources/Opcodes";
			else
				default_opcodedir = "/Applications/Hadron/Contents/Frameworks/CsoundLib64.framework/Resources/Opcodes64";
		#elif _WINDOWS
			if(sizeof(MYFLT) == sizeof(float))
