...
OutFile "Hadron_StatesPack2_DiffractionLeads_VstMfl_Win.exe"
...
!define MUI_WELCOMEPAGE_TEXT "Welcome, we will now start installation of the DiffractionLeads States Pack for the Hadron Particle Synthesizer."
...
SectionIn RO
  ...
  File "..\..\..\states\statespack2\*.spst"

  SetOutPath $INSTDIR\docs
  File "..\..\..\docs\statespack2\*.htm"

  File /r "..\..\StatesPack_doc_rewrite_Win\*.*"

  SetOutPath $INSTDIR
  File "..\..\..\licence_States.txt"
  File "..\HadronStates2_Library.alp"
...
Section "VST presets" Section2
  ...
  IfErrors .abort
  SetOutPath $VSTDIR\DiffractionLeads
  File "..\VST_presets\DiffractionLeads\*.fxp"
  SetOutPath $VSTDIR
...
Section "Max for Live Device preset files, dependent on Cycling74 Max/MSP and Ableton Live" Section3
  ...
  SetOutPath $INSTDIR
  File "..\HadronStates2_Library.alp"
  ExecShell "open" "$INSTDIR\HadronStates2_Library.alp"

SectionEnd

; Descriptions
LangString DESC_Section1 ${LANG_ENGLISH} "The Hadron States and documentations installs into the Hadron DSP library. Presets for (MaxFor)Live devices will be installed into Ableton Live after the DSP installer has finished."
