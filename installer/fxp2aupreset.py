...
print
print ".fxp to .aupreset converter"
print "By: Colin Barry / colin@loomer.co.uk"
print "usage: fxp2aupreset path type subtype manufacturer state_key"
...
rootpath = sys.argv[1]
type = id_to_integer(sys.argv[2])
subtype = id_to_integer(sys.argv[3])
manufacturer = id_to_integer(sys.argv[4])
state_key= sys.argv[5]
...
for fname in fxpFileList:
    convert(fname, manufacturer, subtype, type, state_key)
